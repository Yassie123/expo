...
{washes.length === 0 ? (
  ...
  <FlatList
    ...
    style={{ maxHeight: 300 }} // adjust max height as needed
...
washCard: {
  ...
  height: 60, // FIXED height, so it doesn't expand
  overflow: 'hidden', // keep the card itself clipped
},

carIconBig: {
  width: 110,
  height: 110,
  position: 'absolute', // float outside the card
  top: -25,             // adjust how much it sticks out
  left: 0,
  zIndex: 10,
},
...
plus: {
  ...
  heroContainer: {
    ...
    position: 'relative',
    marginBottom: 80,
    // backgroundColor removed to eliminate orange header
  },
